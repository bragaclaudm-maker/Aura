...
scrollContainer.addEventListener('wheel', (e) => {
    // Se houver scroll vertical (mouse wheel)
    if (e.deltaY !== 0) {
        e.preventDefault();
...
// 4. Animações GSAP (ScrollTrigger horizontal)
gsap.registerPlugin(ScrollTrigger);

// Selecionamos todos os elementos que devem ser revelados
...
revealElements.forEach((el) => {
    gsap.to(el, {
        scrollTrigger: {
            ...
            horizontal: true,       // ScrollTracker deve checar horizontalmente
            start: "left 85%",      // Quando a esquerda do elemento atingir 85% da tela
